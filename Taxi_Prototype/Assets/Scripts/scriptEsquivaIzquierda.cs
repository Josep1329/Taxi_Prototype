...
public class scriptEsquivaIzquierda : MonoBehaviour
{
    ...
    private IEnumerator MoveSequence()
    {
        ...
        // 4. Mover en diagonal hacia (-3.05, -6.46) (nuevas coordenadas)
        targetPosition = new Vector3(-3.05f, -6.46f, transform.position.z);
